          ...
          @csrf
             <div class="form-group row">
               ...
               <div class="form-group row">
                   ...
                   <div class="col-sm-4">
                     <input type="date" name="geboorte_datum" class="form-control" id="inputBirthDate" placeholder="Geboorte datum">
                   </div>
                   <label for="inputId-nummer" class="col-sm-2 col-form-label">ID-Nummer</label>
                   <div class="col-sm-4">
                      <input type="text" name="id_nummer" class="form-control" id="inputId-nummer" placeholder="ID-Nummer">
                   </div>
               </div>
               ...
               <div class="form-group row">
                     ...
                     <div class="col-sm-10">
                        <input type="text" name="mobiel" class="form-control" id="inputMobiel" placeholder="Mobiel nummer">
                     </div>
                </div>
